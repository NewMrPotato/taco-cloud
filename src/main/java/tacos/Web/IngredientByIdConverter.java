...
// Класс для преобразования строкового значения ингредиента, выбраного пользоывателем, в класс Ingredient.
// Тут основная структура классов реализующих Converter.
@Component
